...
export default function TimedRushPage() {
  return (
      ...
      <div className="bg-sky-50/65 px-4 py-8 backdrop-blur-sm sm:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="mb-6">
            ...
            <h1 className="mt-1 text-3xl font-black tracking-tight sm:text-4xl">Three minutes. Three strikes.</h1>
          </div>
          <PuzzleRushGame variant="timed" />
        </div>
      </div>
    </main>
  );
