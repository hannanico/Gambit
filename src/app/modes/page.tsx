      ...
      <section className="min-h-[calc(100vh-4rem)] bg-sky-50/85 px-4 py-12 backdrop-blur-sm sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-7 text-slate-700">
            Every mode uses puzzles saved on your device. Download a pack first,
            then choose the kind of challenge you want.
          </p>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            ...
            <ModeCard
              accent="slate"
              action="Coming next"
              description="Timed survival or no-time, three-strike endurance using the Random Pack."
              disabled
